 ...
 */
class Bid extends \CA\CommerceBundle\Entity\Bid implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CA\\CommerceBundle\\Entity\\Bid' . "\0" . 'user', '' . "\0" . 'CA\\CommerceBundle\\Entity\\Bid' . "\0" . 'product', '' . "\0" . 'CA\\CommerceBundle\\Entity\\Bid' . "\0" . 'id', '' . "\0" . 'CA\\CommerceBundle\\Entity\\Bid' . "\0" . 'amount', '' . "\0" . 'CA\\CommerceBundle\\Entity\\Bid' . "\0" . 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Bid $proxy) {
